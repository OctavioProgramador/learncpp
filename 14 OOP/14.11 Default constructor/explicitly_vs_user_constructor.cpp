...
{
private:
	int m_a; // note: no defualt initialization value
	int m_b {};
...
public:
	Default() = default; // explicity defaulted default constructor
...
int main()
{
	...
	Implicit imp{}; // zerp initialized, then default initialized
