...
{
	IntPair p { 3, 4 };
	return p;	// return temporary object (initialized using p)
}

// Case 2: create temporary IntPair and return
IntPair ret2()
{
	return IntPair { 5, 6 }; // returns temporary object (initialized using
				 // another temporary object)
}

// Case 3: implicityly convert { 7, 8 } to IntPair and return
IntPair ret3()
{
