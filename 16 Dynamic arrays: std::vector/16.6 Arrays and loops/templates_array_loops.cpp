...
T calculateAverage(const std::vector<T>& arr)
{
	...
	T average { 0 }; 	// if our array has elements of type T, our average should
				// have type T too
	...
	average /= static_cast<int>(length);	// divide by cout of items (integral in nature)
	return average;
}
