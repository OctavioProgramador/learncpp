...
#include <cstddef> // for std::size_t and for std::ptrdiff_t

// signed array view provides a view into a container that 
// supports indexing allowing us to work with these types
// using signed indices
